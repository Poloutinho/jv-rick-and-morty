...
import mate.academy.rickandmorty.dto.ApiResponseData;
...
public class CharacterClient {
    ...
    public List<ResponseDto> getCharacters() {
        ...
        try {
            ...
            List<ResponseDto> dtoList = new ArrayList<>(responseData.getResults());
